...
export default {
  ...
  methods: {
    getData() {
      ...
      fetch(`https://happy-gold-capybara.cyclic.app/attendance?day=${day}&onlyPresentUsers=${this.numFromBool(only_present)}&displayTrainers=${this.numFromBool(display_trainers)}`, {
