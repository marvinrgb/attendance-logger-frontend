...
export default {
  ...
  methods: {
    getData() {
      ...
      fetch(`https://attendance-logger-frontend-production.up.railway.app/attendance?day=${day}&onlyPresentUsers=${this.numFromBool(only_present)}&displayTrainers=${this.numFromBool(display_trainers)}`, {
